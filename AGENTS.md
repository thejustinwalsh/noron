...
### Documentation
- When changing public APIs, IPC messages, config keys, CLI commands, action inputs, or build artifacts: update the relevant README, AGENTS.md, and any planning docs in `planning/`
